                ...
                data: ''
                    ...
                    .success(function (result) {
                        ...
                        if (obj != '')
                        {
                            ...
                            if (obj["color"] == "red") {
                                $('#livetopic').html("Dead URL");
                                $('#alivecount').css("background-color", "#E72711");

                            } else if (obj["color"] == "green") {
                                $('#livetopic').html("Alive URL");
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6" id="helpticket">
                            ...
                            <div id="highlight"><br><p id="topic2">Sugar Help Ticket</p></div>
        ...
        <!--	<a href="#"><p id="helpitem">1. HELP-23423</p></a>
                ...
                <a href="#"><p id="helpitem">4. HELP-23370</p></a> -->
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-12" style="margin-top:30px;">
                                            <ul class="demo1" style="height:235px;">	
                        ...
                        <div class="col-md-6" id="alive">
                            <div id="highlight3"><br><p id="topic2">Sugar BUGs</p></div>
...
<?php ?>
        ...
        <script type="text/javascript">
            $(function () {
                ...
                $("#helpticketcount").on('click', function () {
                    window.open('main_helpticket.php');
                    //win.location;
                    // return false;
                });

                $("#bugs").click(function () {
                    window.open('main_bugmessage.php');
                    return false;
                });

                $("#performancetest").on('click', function () {
                    window.open('main_performancetest.php');
                    //win.location;
                    // return false;
                });

                $("#alivecount").on('click', function () {
                    window.open('main_alive.php');
                    //win.location;
                    // return false;
                });
                $("#regressiontest").on('click', function () {
                    window.open('main_regressiontest.php');
                    //win.location;
                    // return false;
                });
                ...
                $("#error").hover(function () {
                    ...
                    if (color1 == "rgb(231, 39, 17)") {
                        $('#error').css("background-color", "#be200e");
                    } else if (color1 == "rgb(155, 187, 88)") {
                        $('#error').css("background-color", "#84a343");
                    } else if (color1 == "rgb(238, 174, 50)") {
                        $('#error').css("background-color", "#d49311");
                    } else {
                        $('#error').css("background-color", "#8c8c8c");
                    }
                    ...
                    $("#error").css("background-color", color1);
                });

                var color2;
                $("#performancetest").hover(function () {
                    color2 = $(this).css("background-color");

                    if (color2 == "rgb(231, 39, 17)") {
                        $('#performancetest').css("background-color", "#be200e");
                    } else if (color2 == "rgb(155, 187, 88)") {
                        $('#performancetest').css("background-color", "#84a343");
                    } else if (color2 == "rgb(238, 174, 50)") {
                        $('#performancetest').css("background-color", "#d49311");
                    } else {
                        $('#performancetest').css("background-color", "#8c8c8c");
                    }
                    ...
                    $("#performancetest").css("background-color", color2);
                });

                var color3;
                $("#regressiontest").hover(function () {
                    color3 = $(this).css("background-color");

                    if (color3 == "rgb(231, 39, 17)") {
                        $('#regressiontest').css("background-color", "#be200e");
                    } else if (color3 == "rgb(155, 187, 88)") {
                        $('#regressiontest').css("background-color", "#84a343");
                    } else if (color3 == "rgb(238, 174, 50)") {
                        $('#regressiontest').css("background-color", "#d49311");
                    } else {
                        $('#regressiontest').css("background-color", "#8c8c8c");
                    }
                    ...
                    $("#regressiontest").css("background-color", color3);
                });

                var color4;
                $("#bugs").hover(function () {
                    color4 = $(this).css("background-color");

                    if (color4 == "rgb(231, 39, 17)") {
                        $('#bugs').css("background-color", "#be200e");
                    } else if (color4 == "rgb(155, 187, 88)") {
                        $('#bugs').css("background-color", "#84a343");
                    } else if (color4 == "rgb(238, 174, 50)") {
                        $('#bugs').css("background-color", "#d49311");
                    } else {
                        $('#bugs').css("background-color", "#8c8c8c");
                    }
                    ...
                    $("#bugs").css("background-color", color4);
                });

                var color5;
                $("#helpticketcount").hover(function () {
                    color5 = $(this).css("background-color");

                    if (color5 == "rgb(231, 39, 17)") {
                        $('#helpticketcount').css("background-color", "#be200e");
                    } else if (color5 == "rgb(155, 187, 88)") {
                        $('#helpticketcount').css("background-color", "#84a343");
                    } else if (color5 == "rgb(238, 174, 50)") {
                        $('#helpticketcount').css("background-color", "#d49311");
                    } else {
                        $('#helpticketcount').css("background-color", "#8c8c8c");
                    }
                    ...
                    $("#helpticketcount").css("background-color", color5);
                });

                var color6;
                $("#alivecount").hover(function () {
                    color6 = $(this).css("background-color");

                    if (color6 == "rgb(231, 39, 17)") {
                        $('#alivecount').css("background-color", "#be200e");
                    } else if (color6 == "rgb(155, 187, 88)") {
                        $('#alivecount').css("background-color", "#84a343");
                    } else if (color6 == "rgb(238, 174, 50)") {
                        $('#alivecount').css("background-color", "#d49311");
                    } else {
                        $('#alivecount').css("background-color", "#8c8c8c");
                    }
                    ...
                    $("#alivecount").css("background-color", color6);
                });
